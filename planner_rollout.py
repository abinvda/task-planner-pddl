...
#TODO: This file is not useful as of now. Nothing new has been implemented here.
# from multiprocessing import Pool
# from random import randint
# import pyddl
# from pyddl import listit
def planner_rollout(problem, heuristic=None, state0=None, goal=None,
            monotone=False, verbose=True, nPlans=1, optimal_actions={}, calculate_all_paths=0):
    """
    ...
    if not goal:
        ...
        goal = (pos_goals, neg_goals, problem.num_goals)
    states_explored = 0
    closed = set()
    ...
    while True:
        ...
        ff, _, node = heapq.heappop(fringe)
        fringe = [(999, -1, 'nothing')]
        heapq.heapify(fringe)
        states_explored += 1
        if ff == 999:
            t=1
        ...
        if node in optimal_actions.keys():
            ...
            f = successor.cost + h - 0.01  #TODO: Check if this can result in sub-optimality
